...
const file_tasks_proto_rawDesc = "" +
	...
	"\aGetTask\x12\x15.tasks.GetTaskRequest\x1a\x16.tasks.GetTaskResponseB$Z\"lista_de_tarefas_grpc/go_server/pbb\x06proto3"
...
var file_tasks_proto_depIdxs = []int32{
	...
	4,  // 10: tasks.TaskService.ListTasks:output_type -> tasks.ListTasksResponse
	...
	10, // 13: tasks.TaskService.GetTask:output_type -> tasks.GetTaskResponse
